...
if ( ! class_exists( 'Base' ) ) {
    ...
    class Base {
        ...
        function __construct() {
            ...
            add_action( 'genesis_init', array( $this, 'fix_title_attr_filter' ), 15 );
...
<div class="site-info">
	<div class="wrap">';
        ...
        /**
         * Remove the Genesis Accessible filter that strips out title attributes on everything
         */
        public function fix_title_attr_filter() {
            remove_filter( 'the_content', 'wpaccgen_remove_title_attr', 1000 );
            add_filter( 'the_content', array( $this, 'remove_title_attr' ), 1000 );
        }

        /**
         * Strip the title attribute from links, but leave it on other elements
         *
         ...
         * @since  2026.04.24
         */
        public function remove_title_attr( string $content = '' ): string {
