...
if ( ! class_exists( 'Root' ) ) {
    ...
    class Root extends Base {
        var string $dbversion = '20150522/090000';

        var array $shortcodes_to_unregister = array();
            ...
            if ( defined( 'UMW_CB_VERSION' ) ) {
                ...
                <div class="umw-logo-block"><a href="<?php echo $logo_info['link'] ?>"
                        ...
                        <svg id="<?php echo $logo_info['logo_id'] ?>" class="<?php echo $logo_info['logo_class'] ?>"
                             version="1.1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 270.4 69.4"
                             xml:space="preserve"><title><?php _e( 'University of Mary Washington' ) ?></title>
                            <style>.st0 {
                                    fill: #fff
                                }</style>
                            <path class="st0"
